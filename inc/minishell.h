...
/*   Updated: 2025/08/07 18:12:03 by emcorona         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int			create_word(t_word **word_list, char *command_input, int start_index, int word_len, int word_type); //TODO PASAR A 4 ARGUMENTOS
...
int			create_token(t_token **token_list, char *raw_word, int start_index, int token_len, int token_type); //TODO PASAR A 4 ARGUMENTOS
